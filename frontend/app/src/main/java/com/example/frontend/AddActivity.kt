...
/*
        //취소버튼을 만들 경우
        val btncancel = findViewById<TextView>(com.example.frontend.R.id.cancel)
...
*/
        ...
        val searchTargets = arrayListOf<String>("")
        ...
        //우선AddToEdit(추가하기)를 누르면 내용이Edit페이지에 추가 되어야 하지만, 우선 EditToEdit(추가하기)버튼을 눌렀을 때 페이지가 넘어가게함
        val btnconfirm = findViewById<TextView>(com.example.frontend.R.id.AddToEdit)
